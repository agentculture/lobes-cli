...
:mod:`model_gear.realtime.audio_facade` (codec + request parsing) and
:mod:`model_gear.realtime.tts_client`, which are tested directly. The routes here
...
app = FastAPI(title="model-gear realtime", version="1")
...
def main() -> None:  # pragma: no cover - process entrypoint
    ...
    log.info("starting model-gear realtime on %s:%d", settings.host, settings.port)
